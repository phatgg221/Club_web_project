    ...
    <footer className={styles.footer}>
      <div className={styles.info}>
        ...
        <div className={styles.logos}>
          <a target="_blank" href='https://www.facebook.com/RMITCompetitionClub '>
            <svg
          ...
          <a target="_blank" href='https://www.instagram.com/gfcclub_rmit/?fbclid=IwAR3l_3TxlK2Axp1A4ll-q3_UmFlN2lgwMY4JDd-7BZeRBEEajAdwH5I-vCk'>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="32"
              width="28"
